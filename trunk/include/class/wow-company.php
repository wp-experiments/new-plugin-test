...
class Wow_Company {
	...
	function add_menu() {
		add_menu_page( 'Wow-Company', 'Wow-Company', 'manage_options', 'wow-company', array(
			$this,
			'main_page'
		), plugin_dir_url( __FILE__ ) . 'menu/icon.png' );
	...
	function save_data() {
		...
		$add     = ( isset( $_POST["add"] ) ) ? sanitize_text_field( $_POST["add"] ) : '';
