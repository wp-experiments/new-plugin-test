...
<form id="plugin-filter">
    <div class="wrap about-wrap wow-icons">
        <p style="padding-bottom: 5px;margin-bottom:30px;"><span class="dashicons dashicons-megaphone"></span>&nbsp;&nbsp;<?php _e( 'Several plugins below is free and you can install it and hopefully useful. Enjoy it!', 'wow-icons' ); ?>
        </p>
                    ...
                    <div class="plugin-card">
                        ...
                        <div class="wow-button-con">
							...
							if ( $action_links ) {
								...
								echo '<li>' . esc_url($action_links[0]) . '</li>';
								switch ( $plugin["slug"] ) {
									case "modal-window" :
